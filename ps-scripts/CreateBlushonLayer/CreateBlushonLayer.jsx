#target photoshop
//
// CreateBlushonLayer.jsx
//

//
// Generated Thu Jan 26 2017 18:06:17 GMT+0500
//
...
//
//==================== Create Blushon Layer ==============
//
function CreateBlushonLayer() {
  // Flatten Image
  ...
  function step6(enabled, withDialog) {
    ...
    desc3.putInteger(cTID('DstW'), 130);
  ...
  function step7(enabled, withDialog) {
    ...
    desc1.putReference(cTID('null'), ref1);
    var desc2 = new ActionDescriptor();
    desc2.putString(cTID('Nm  '), "Blushon Layer");
    desc1.putObject(cTID('T   '), cTID('Lyr '), desc2);
    executeAction(cTID('setd'), desc1, dialogMode);
  };
  ...
  function step8(enabled, withDialog) {
    ...
    desc1.putReference(cTID('null'), ref1);
    var desc2 = new ActionDescriptor();
    desc2.putDouble(cTID('Rd  '), 255);
    desc2.putDouble(cTID('Grn '), 157);
    desc2.putDouble(cTID('Bl  '), 199);
...
//=========================================
//                    CreateBlushonLayer.main
//=========================================
//

CreateBlushonLayer.main = function () {
  CreateBlushonLayer();
};
