#target photoshop
//
// CreateEyeshadeLayer.jsx
//

//
// Generated Thu Jan 26 2017 17:54:37 GMT+0500
//
...
//
//==================== Create Eyeshade Layer ==============
//
function CreateEyeshadeLayer() {
  // Flatten Image
  ...
  function step8(enabled, withDialog) {
    ...
    desc1.putReference(cTID('null'), ref1);
    var desc2 = new ActionDescriptor();
    desc2.putString(cTID('Nm  '), "Eyeshade Layer");
    desc1.putObject(cTID('T   '), cTID('Lyr '), desc2);
    executeAction(cTID('setd'), desc1, dialogMode);
  };
...
//=========================================
//                    CreateEyeshadeLayer.main
//=========================================
//

CreateEyeshadeLayer.main = function () {
  CreateEyeshadeLayer();
};
